                                                                        ...
                                                                        <div class="card-body">
                                                                            <a href="{{ route('frontend.apply-jobs') }}" class="text-decoration-none text-black">
                                                                                ...
                                                                                <div class="d-flex justify-content-end">
                                                                                        <span class="d-flex justify-content-center align-items-center gap-2 applyjob">
                                                                                            <span class="skill_check matchSkill d-flex justify-content-center align-items-center" ><i class="ri-check-line"></i></span>
